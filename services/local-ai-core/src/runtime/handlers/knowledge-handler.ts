...
export function registerKnowledgeHandlers(
  ...
  map.set('knowledge.config.update', async (_route, req, res) => {
    ...
    json(res, 200, await knowledgeProvider.updateConfig(body as Partial<import('../../../../../packages/contracts/src/index.js').KnowledgeConfig>));
  });
  ...
  map.set('knowledge.folders.create', async (_route, req, res) => {
    const body = await readJsonBody(req);
    json(res, 200, await knowledgeProvider.createFolder(body as unknown as import('../../../../../packages/contracts/src/index.js').KnowledgeFolderCreateInput));
  });
  map.set('knowledge.folder.update', async (route, req, res) => {
    const body = await readJsonBody(req);
    json(res, 200, await knowledgeProvider.updateFolder((route as { folderId: string }).folderId, body as unknown as import('../../../../../packages/contracts/src/index.js').KnowledgeFolderUpdateInput));
  });
  ...
  map.set('knowledge.bases.create', async (_route, req, res) => {
    const body = await readJsonBody(req);
    json(res, 200, await knowledgeProvider.createKnowledgeBase(body as unknown as import('../../../../../packages/contracts/src/index.js').KnowledgeBaseCreateInput));
  });
  ...
  map.set('knowledge.base.update', async (route, req, res) => {
    const body = await readJsonBody(req);
    json(res, 200, await knowledgeProvider.updateKnowledgeBase((route as { knowledgeBaseId: string }).knowledgeBaseId, body as import('../../../../../packages/contracts/src/index.js').KnowledgeBaseUpdateInput));
  });
  ...
  map.set('knowledge.base.search', async (route, req, res) => {
    const body = await readJsonBody(req);
    json(res, 200, { results: await knowledgeProvider.searchKnowledgeBase((route as { knowledgeBaseId: string }).knowledgeBaseId, body as unknown as import('../../../../../packages/contracts/src/index.js').KnowledgeSearchInput) });
  });
}
