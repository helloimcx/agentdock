...
const MONITOR_INSTRUCTION = [
  ...
  'Supported stock metrics include latestPrice, change_percent, abs_change_percent, boll_upper, boll_middle, boll_lower, boll_percent_b, boll_distance_to_lower, boll_distance_to_upper, and boll_signal.',
  'Weekly Bollinger Band (周线布林线) trading strategy examples:',
